...
#SBATCH --job-name=parser_spectral
...
#SBATCH --qos=csqos
##SBATCH --reservation=trahman2_89
...
#SBATCH --mem=	1000G	  # Total memory needed per task (units: K,M,G,T)
##SBATCH --time=5-0:0 #tal time needed for job: Days-Hours:Minutes
#SBATCH --time=0-12:0
## ##### Optional stuff #####
...
####SBATCH --array=1-2     # Start-End[:Increment][%MaxAtOnce] []=optional
